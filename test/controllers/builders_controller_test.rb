...
class BuildersControllerTest < ActionController::TestCase
  ...
  test "should create builder" do
    assert_difference('Builder.count') do
      post :create, builder: { company: @builder.company, email1: @builder.email1, email2: @builder.email2, email: @builder.email, name: @builder.name, phone1: @builder.phone1, phone2: @builder.phone2, phone: @builder.phone }
    end
  ...
  test "should update builder" do
    patch :update, id: @builder, builder: { company: @builder.company, email1: @builder.email1, email2: @builder.email2, email: @builder.email, name: @builder.name, phone1: @builder.phone1, phone2: @builder.phone2, phone: @builder.phone }
    assert_redirected_to builder_path(assigns(:builder))
  end
